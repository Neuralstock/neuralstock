...
var require_gltf_validator_dart = __commonJS({
  "node_modules/.pnpm/gltf-validator@2.0.0-dev.3.10/node_modules/gltf-validator/gltf_validator.dart.js"(exports2) {
    ...
    if (self.scheduleImmediate = "undefined" != typeof setImmediate ? function(e) {
      ...
      setTimeout(e, 0);
    }, "undefined" != typeof require) self.require = require;
    if ("undefined" != typeof exports2) self.exports = exports2;
    ...
    if (dartNodeIsActuallyNode) {
      url = ("undefined" != typeof __webpack_require__ ? __non_webpack_require__ : require)("url");
    ...
    (function dartProgram() {
      ...
      var A = {
        ...
        tR(a, b) {
          return A.mt(v.typeUniverse, A.ak(a.a), b);
        },
        ow(a) {
          return a.a;
        },
        ...
        aR(a) {
          return A.fT(v.typeUniverse, a, false);
        },
        bT(a, b, a0, a1) {
        ...
        wj(a, b) {
          var s = a instanceof A.c7 ? a.__proto__.__proto__.constructor : b, r = A.vH(v.typeUniverse, s.name);
          b.$ccache = r;
          return r;
        },
        xb(a) {
        ...
        pL(a) {
          ...
          q = A.fT(v.typeUniverse, r, true);
          p = q.w;
          return a.w = p == null ? q.w = new A.eh(q) : p;
        },
        u(a) {
          return A.pL(A.fT(v.typeUniverse, a, false));
        },
        wi(a) {
        ...
        nl(a, b) {
          if (typeof b === "number") {
            if (a.constructor == Array || typeof a == "string" || A.pU(a, a[v.dispatchPropertyName])) {
        ...
        tv(a, b, c) {
          if (typeof b === "number") {
            if ((a.constructor == Array || A.pU(a, a[v.dispatchPropertyName])) && !a.immutable$list && b >>> 0 === b && b < a.length) return a[b] = c;
          }
      ...
      A.aF.prototype = {
        h(a) {
          return A.mt(v.typeUniverse, this, a);
        },
        I(a) {
          return A.vG(v.typeUniverse, this, a);
        }
      };
      A.fK.prototype = {};
      A.eh.prototype = {
        ...
        e3(a, b, c, d) {
          ...
          $label0$0: for (s = l.a; true; ) {
            for (; true; g = p) {
              ...
              j = B.a.J(" \x000:XECCCCCN:lDb \x000:XECCCCCNvlDb \x000:XECCCCCN:lDb AAAAA\0\0\0\0\0AAAAA00000AAAAA:::::AAAAAGG000AAAAA00KKKAAAAAG::::AAAAA:IIIIAAAAA000\x800AAAAA\0\0\0\0 AAAAA", j + r);
              if (j === 0) {
                h.a += A.be(i);
...
var require_gltf_validator = __commonJS({
  "node_modules/.pnpm/gltf-validator@2.0.0-dev.3.10/node_modules/gltf-validator/index.js"(exports2) {
    var validator2 = require_gltf_validator_dart();
    exports2.version = () => validator2.version();
    exports2.supportedExtensions = () => validator2.supportedExtensions();
    exports2.validateBytes = (data, options) => validator2.validateBytes(data, options);
    exports2.validateString = (json, options) => validator2.validateString(json, options);
  }
});

// tools/validate-gltf.mjs
var import_promises = require("node:fs/promises");
var import_node_path = require("node:path");
var import_gltf_validator = __toESM(require_gltf_validator(), 1);
function usage() {
...
async function main() {
  ...
  try {
    const bytes = await (0, import_promises.readFile)(modelPath);
    const report = await import_gltf_validator.default.validateBytes(new Uint8Array(bytes), {
      format: "glb",
      maxIssues: 0,
      uri: (0, import_node_path.basename)(modelPath),
