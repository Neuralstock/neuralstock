/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/r2-bootstrap/wrangler.jsonc cloudflare/r2-bootstrap/worker-configuration.d.ts` (hash: a8305ad5c937c02f00f2ef4669f734fe)
